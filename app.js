function buscarDetalhes(){
    ...
    var lista = ['beng','bamb','bali', 'amau', 'asho']
    ...
    var temperamento = retorno[0].temperament
    ...
    document.getElementById("nome_raca").innerHTML="Raça: "+raca
    document.getElementById("temperamento_raca").innerHTML="Temperamento: "+retorno[0].temperamento
